...
SIMPLE = os.path.dirname(os.path.abspath(__file__))
PIPELINES = os.path.dirname(SIMPLE)
...
def first_pipeline():
    ...
    data_quality_report = kfp.components.load_component_from_file(os.path.join(ROOT, 'components', 'evidently', 'data_quality_base', 'component.yaml'))

    data_download_op = kfp.components.load_component_from_file(os.path.join(PIPELINES, 'datasets', 'download_datasets', 'download_data_component.yaml'))
    
    dataset_task = data_download_op(dataset='load_iris').output
    # # Run download_data task
    # download_task = download()
    
    # # Run data quality report
    # data_quality_report(
    #     cur_data=download_task.output
    # )
